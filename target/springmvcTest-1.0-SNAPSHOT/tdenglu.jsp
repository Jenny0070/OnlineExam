...
<div class="div1">
    <div class="div2_1">
        <div class="div3_1">
            <img src="${ctx}/static/custom/images/logo.jpg"/>
        </div>
        <div class="div3_2">
            <span>在线考试系统</span>
        </div>
    ...
    <div class="div2_2">
        <center>
            ...
            <form id="form1" action="${ctx}/admin/login" method="post" onsubmit="return checkForm()" >
                <table border="0px">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align:left;">
                            <input id="uid" value="" type="text" style="width:160px;" name="uid" onblur="checkId()" />
                        </td>
                    ...
                    <tr>
                        ...
                        <td style="text-align:left;">
                            <input id="password" type="password" value="" style="width:160px;" name="password" onblur="checkPW()"/>
                        </td>
