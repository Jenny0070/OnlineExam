...
<head>
    ...
    <title>My JSP 'sdenglu.jsp' starting page</title>
...
<div class="div1">
    ...
    <div class="div2_2">
        <center>
            ...
            <form id="form1" action="/student/login"  onsubmit="return checkForm()" >
                <table border="0px">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align:left;">
                            <input id="sid" value="" type="text" style="width:160px;" name="sid" onblur="checkId()" />
                        </td>
        ...
        <span id="errspan" style=""><s:actionerror/></span>
    </div>
</div>
</body>
</html>
